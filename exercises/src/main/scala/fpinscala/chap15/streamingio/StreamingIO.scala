package fpinscala.chap15.streamingio

import fpinscala.chap13.iomonad.{IO,Monad,Free,unsafePerformIO}
...
object SimpleStreamTransducers {
  ...
  sealed trait Process[I,O] {
     ...
     * as `this` is in the `Await` fpinscala.chap6.state.
     */
  ...
  object Process {
    ...
    import fpinscala.chap13.iomonad.Monad
     ...
     * piece of fpinscala.chap6.state (in this case, the running total):
     */
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.chap13.iomonad.IO
    ...
    def runLog[O](src: Process[IO,O]): IO[IndexedSeq[O]] = IO {
      ...
      def go(cur: Process[IO,O], acc: IndexedSeq[O]): IndexedSeq[O] =
        cur match {
          ...
          case Await(req,recv) =>
            val next =
              try recv(Right(fpinscala.chap13.iomonad.unsafePerformIO(req)(E)))
    ...
    import fpinscala.chap13.iomonad.IO0.fahrenheitToCelsius
